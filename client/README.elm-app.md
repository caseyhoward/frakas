...
- [Elm App](#elm-app)
  ...
  - [Using elm-css](#using-elm-css)
    ...
    - [Step 4: Compiling the stylesheet](#step-4-compiling-the-stylesheet)
  ...
  - [Deployment](#deployment)
    ...
    - [Netlify](#netlify)
      - [Step 1: Create a `package.json` file](#step-1-create-a-packagejson-file)
      - [Step 2: `npm install --save-dev create-elm-app`](#step-2-npm-install---save-dev-create-elm-app)
      - [Step 3: Add a build script to the `package.json` file](#step-3-add-a-build-script-to-the-packagejson-file)
      - [Step 4: Add a netlify.toml file in the repo's root](#step-4-add-a-netlifytoml-file-in-the-repos-root)
      - [Step 5: Go to the netlify settings and set the publish directory to `build` and the build command to `npm run build`](#step-5-go-to-the-netlify-settings-and-set-the-publish-directory-to-build-and-the-build-command-to-npm-run-build)
    - [GitHub Pages](#github-pages)
      - [Step 1: Add `homepage` to `elmapp.config.js`](#step-1-add-homepage-to-elmappconfigjs)
